...
import Gnosis.SExp (SExp, parseSExp, findInTree)
...
extractContext tree = Map.fromList
    ...
    , ("downloads", mkFlexiText "downloads" (findInTree "downloads" tree))
    , ("tags", mkFlexiText "tags" (findInTree "tags" tree))
