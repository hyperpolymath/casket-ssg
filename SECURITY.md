...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/casket-ssg/security/advisories/new)
...
| **Fingerprint** | *Available at key URL above* |
...
- This repository (`hyperpolymath/casket-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/casket-ssg/security/advisories)
...
When using casket-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/casket-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/casket-ssg/security/advisories/new) or security@hyperpolymath.org |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/casket-ssg/discussions) |
...
*Thank you for helping keep casket-ssg and its users safe.* 🛡️
